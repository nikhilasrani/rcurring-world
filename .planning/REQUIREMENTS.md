...
- [ ] **PLAT-01**: Game runs in a web browser (Chrome, Safari, Firefox)
- [ ] **PLAT-02**: Virtual D-pad and action button overlay appears on touch devices
- [ ] **PLAT-03**: Touch controls do not obscure the gameplay area
