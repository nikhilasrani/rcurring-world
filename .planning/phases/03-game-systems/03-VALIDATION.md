...
| 03-02-03 | 02 | 1 | INVT-03 | unit | `vitest run tests/unit/item-catalog.test.ts --reporter=verbose` | ❌ W0 | ⬜ pending |
...
| 03-04-02 | 04 | 2 | MTRO-02 | unit | `vitest run tests/unit/metro-manager.test.ts --reporter=verbose` | ❌ W0 | ⬜ pending |
...
- [ ] `tests/unit/item-catalog.test.ts` — stubs for INVT-03
- [ ] `tests/unit/journal-manager.test.ts` — stubs for JRNL-01, JRNL-02, JRNL-03
- [ ] `tests/unit/metro-manager.test.ts` — stubs for MTRO-02
