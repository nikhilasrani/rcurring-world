...
- **Global scope**: `/home/nikhil/Code/Game/rcurring-world/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/nikhil/Code/Game/rcurring-world/.claude/notes/`)
...
2. Glob `/home/nikhil/Code/Game/rcurring-world/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/nikhil/Code/Game/rcurring-world/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/nikhil/Code/Game/rcurring-world/.claude/notes/` — works in any directory
