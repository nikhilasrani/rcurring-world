...
- Usage: Reference from command with `@/home/nikhil/Code/Game/rcurring-world/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/nikhil/Code/Game/rcurring-world/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/nikhil/Code/Game/rcurring-world/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
